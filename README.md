...
This problem is **intentionally open-ended**. There's no single "right answer". We want to see how you approach ambiguous problems, make decisions, and exercise creativity. Your solution will give us a glimpse into how you work.
...
**Note:** These three files are examples for development. We will also test your solution with additional FHIR bundles not included here, so build for the general case rather than hardcoding for these specific files.
